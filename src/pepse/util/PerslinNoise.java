...
/**
 * Perlin noise is a Function can be used to generate various effects with natural qualities
 */
public class PerslinNoise {
    private double seed;
    private long default_size;
    private int[] p;
    private int[] permutation;

    public PerslinNoise(double seed) {
        this.seed = seed;
        init();
    }

    public PerslinNoise(int seed) {
        this.seed = seed;
        init();
    }
